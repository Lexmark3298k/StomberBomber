...
from levels.salon3 import Salon3
from levels.salon4 import Salon4
from levels.salon5 import Salon5
...
class GameState:
    ...
    def start_transition(self, next_level):
        ...
        self.transition_timer = 60  # 1 segundo a 60 FPS
        self.next_level = next_level
        
    def draw(self):
        """Dibuja el estado actual"""
        if self.transition_active:
            # Dibujar el nivel actual con overlay
            self.level.draw()
            ...
            if self.next_level <= self.max_level:
                ...
                sub_text = sub_font.render(level_names.get(self.next_level, ""), True, YELLOW)
